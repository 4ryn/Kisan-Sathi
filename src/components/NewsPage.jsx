...
export default function NewsPage() {
  ...
  useEffect(() => {
    axios
      .get(
        "https://api.openweathermap.org/data/2.5/weather?q=Bhopal&appid=7d4c96fbf0e555a565fd252f803c3eb1&units=metric"
      )
      .then((res) => setWeather(res.data));

    axios
      .get(
        "https://newsapi.org/v2/everything?q=indian%20farmers&apiKey=d66e17ff3ecf4212a6088c0bcac84fcb&pageSize=4&sortBy=publishedAt&language=en"
      )
